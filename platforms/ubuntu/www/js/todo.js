...
},{"./TodoItem":2,"react":168}],2:[function(require,module,exports){
/// <reference path="../typings/browser.d.ts" />
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
...
var TodoItem = (function (_super) {
    ...
    TodoItem.prototype.render = function () {
        return (React.createElement("div", {className: "row"}, React.createElement("div", {className: "col s12 m6"}, React.createElement("div", {className: "card blue-grey darken-1"}, React.createElement("div", {className: "card-content white-text"}, React.createElement("span", {className: "card-title"}, " ", this.props.item.description, " ")), React.createElement("div", {class: "card-action"}, React.createElement("a", {href: "javascript:void(0);", onClick: this.removeItem}, "Delete"))))));
    };
    return TodoItem;
}(React.Component));
...
ReactDOM.render(React.createElement(Main_1.Main), document.getElementById('app'));

},{"./Main":1,"react":168,"react-dom":5}],4:[function(require,module,exports){
